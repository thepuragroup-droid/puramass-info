...
import type { Section } from "@/lib/protocols/types";
    ...
    <>
      <nav className="crumb">
        <div className="wrap py-3 text-sm">
          ...
          <Link href="/single-peptide-dosages">Single-Peptide Dosages</Link>
          <span className="sep">/</span>
      ...
      <section className="pt-10">
        <div className="wrap">
          <span className="eyebrow">Single-Peptide Protocol</span>
          <h1>{p.title}</h1>
